    ...
    <>
      <main className="min-h-screen bg-gradient-to-b from-gray-950 via-indigo-950 to-purple-950 text-gray-200">
        <header className="flex items-center justify-between px-6 py-4 border-b border-indigo-900 bg-indigo-900/30 backdrop-blur-sm">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="px-4 py-2 border rounded border-indigo-800 text-indigo-200 hover:bg-indigo-900"
            >
              Sign In
            </button>
            <button
              ...
              className="px-4 py-2 border rounded bg-indigo-700 text-white hover:bg-indigo-800"
            >
              Sign Up
            </button>
          </div>
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            >
              <div
                ...
                className="relative inline-block px-8 py-4 bg-gradient-to-r from-indigo-600 via-indigo-700 to-indigo-800 text-white rounded-lg text-lg font-semibold shadow-lg hover:shadow-2xl transition-all overflow-hidden cursor-pointer group"
              >
        ...
        <section className="px-6 py-24" data-aos="fade-up" id="our-impact">
          <h2 className="text-4xl font-bold text-center text-indigo-100 mb-16">
            Our Impact
          </h2>
        ...
        >
          ...
          <div className="relative flex flex-col space-y-24 max-w-6xl mx-auto px-4 sm:px-8">
            <div
              className="absolute w-1 left-1/2 top-[130px] transform -translate-x-1/2 bg-indigo-700 transition-all duration-1000 ease-in-out"
              id="scroll-line"
              style={{ height: "0px" }}
            >
            ...
            <div
              className="relative z-10 flex flex-col md:flex-row items-center md:items-start text-center md:text-left gap-6 md:gap-12 opacity-0 translate-y-12 transition-all duration-700 ease-out"
              data-step-index="0"
            >
              <div className="w-14 h-14 rounded-full bg-indigo-700 text-white flex items-center justify-center text-2xl">
                📝
              </div>
              <div>
                ...
                <p className="text-indigo-400 max-w-sm">
                  Create your free account in seconds and access all features
                  instantly.
                </p>
              </div>
            </div>
            ...
            <div
              className="relative z-10 flex flex-col md:flex-row-reverse items-center md:items-start text-center md:text-right gap-6 md:gap-12 opacity-0 translate-y-12 transition-all duration-700 ease-out"
              data-step-index="1"
            >
              <div className="w-14 h-14 rounded-full bg-indigo-700 text-white flex items-center justify-center text-2xl">
                🎒
              ...
              <div>
                ...
                <p className="text-indigo-400 max-w-sm">
                  Import your CS2 inventory and start tracking your assets
                  automatically.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-indigo-400 max-w-sm">
                  Keep full control over your purchases, sales, and market
                  activity.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-indigo-400 max-w-sm">
                  Visualize your results and boost your performance with
                  detailed analytics.
                </p>
              </div>
            </div>
        ...
        <section className="px-6 py-24" data-aos="fade-up">
          <h2 className="text-4xl font-bold text-center text-indigo-100 mb-16">
            Why Choose CS2 Trader Companion?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 max-w-6xl mx-auto text-center">
            <div className="bg-indigo-900 p-8 rounded-xl shadow-lg">
              ...
              <p className="text-indigo-400">
                Get real-time price alerts and trade notifications faster than
                ever.
              </p>
            </div>
            <div className="bg-indigo-900 p-8 rounded-xl shadow-lg">
              ...
              <p className="text-indigo-400">
                Track your trading performance with beautiful, easy-to-read
                charts.
              </p>
            </div>
            <div className="bg-indigo-900 p-8 rounded-xl shadow-lg">
              ...
              <p className="text-indigo-400">
                Your data stays yours. We prioritize security and transparency.
              </p>
            </div>
          </div>
        </section>
            ...
            >
              <SwiperSlide>
                <div className="bg-indigo-900 rounded-xl p-8 shadow-lg text-center">
                  <p className="text-indigo-300 italic mb-6">
                    "The profit tracking system is insanely helpful. I actually
                    make smarter trades now."
                  </p>
              ...
              <SwiperSlide>
                <div className="bg-indigo-900 rounded-xl p-8 shadow-lg text-center">
                  <p className="text-indigo-300 italic mb-6">
                    "Everything is so smooth. From price alerts to managing my
                    inventory, it's all top-notch."
                  </p>
                  <div className="text-indigo-400 font-semibold">
                    — Jordan, marketplace flipper
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="bg-indigo-900 rounded-xl p-8 shadow-lg text-center">
                  <p className="text-indigo-300 italic mb-6">
                    "I’ve increased my ROI just by using the player profile
                    analytics. Amazing insights!"
                  </p>
                  <div className="text-indigo-400 font-semibold">
                    — Casey, pro trader
                  </div>
        ...
        <footer
          className="px-6 py-12 border-t border-indigo-900 flex flex-col md:flex-row justify-between items-center text-indigo-400 text-sm"
          data-aos="fade-up"
        >
